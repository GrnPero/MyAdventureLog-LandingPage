...
import * as Styles from "../components/Terms/Terms.module.css";
...
const Terms: React.FC<PageProps> = () => {
  useEffect(() => {
    ...
    const scrollToSection = () => {
      const sectionId = "terms"; // Change this to the desired section id
  ...
  return (
    <Layout>
      <main id="terms" className={Styles.background}>
        <div className={Styles.container}>
          <h1 className={Styles.heading}>TERMS OF SERVICE</h1>
          <h2 className={Styles.subheading}> OVERVIEW</h2>
          <p className={Styles.text}>
            This website is operated by MyAdventureLog. Throughout the site, the
            terms “we”, “us” and “our” refer to MyAdventureLog. MyAdventureLog
          ...
          <h2 className={Styles.subheading}>SECTION 1 - ONLINE STORE TERMS </h2>
          <p className={Styles.text}>
          ...
          <h2 className={Styles.subheading}>SECTION 2 - GENERAL CONDITIONS </h2>
          <p className={Styles.text}>
          ...
          <p className={Styles.text}>
            ...
            our Return Policy. To view our Return Policy, please contact us at
            app.myadventurelog@gmail.com We have made every effort to display as
          ...
          <h2 className={Styles.subheading}>SECTION 7 - OPTIONAL TOOLS</h2>
          <p className={Styles.text}>
          ...
          <h2 className={Styles.subheading}>SECTION 8 - THIRD-PARTY LINKS</h2>
          <p className={Styles.text}>
          ...
          <h2 className={Styles.subheading}>SECTION 12 - PROHIBITED USES</h2>
          <p className={Styles.text}>
          ...
          <p className={Styles.text}>
            ...
            MyAdventureLog, our directors, officers, employees, affiliates,
          ...
          <h2 className={Styles.subheading}>SECTION 14 - INDEMNIFICATION</h2>
          <p className={Styles.text}>
            You agree to indemnify, defend and hold harmless MyAdventureLog and
          ...
          <h2 className={Styles.subheading}>SECTION 15 - SEVERABILITY</h2>
          <p className={Styles.text}>
          ...
          <h2 className={Styles.subheading}>SECTION 16 - TERMINATION</h2>
          <p className={Styles.text}>
          ...
          <h2 className={Styles.subheading}>SECTION 17 - ENTIRE AGREEMENT</h2>
          <p className={Styles.text}>
          ...
          <h2 className={Styles.subheading}>SECTION 18 - GOVERNING LAW</h2>
          <p className={Styles.text}>
          ...
          <p className={Styles.text}>
            ...
            app.myadventurelog@gmail.com. Our contact information is posted
            below: app.myadventurelog@gmail.com
          </p>
        </div>
      </main>
    </Layout>
